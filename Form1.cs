...
namespace OpenTK3_StandardTemplate_WinForms
{
    public partial class MainForm : Form
    {
        ...
        private Camera cam;
        private Scene scene;
        private Cub3D planetCube;
        private Point mousePosition;
        private Cub3D sunCube;
        private Cub3D moonCube;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            planetCube = new Cub3D(1, 20, 20, 1, Color.Blue);
            sunCube = new Cub3D( 1, 20, 20,2,Color.Yellow);
            moonCube = new Cub3D(1, 20, 20, 0.5f, Color.Gray);
        ...
        private void mainViewport_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (enableAnimation.Checked)
            {
                ...
                moonCube.setXYZ(planetCube.x + xPlaneta, planetCube.y + yPlaneta, planetCube.z);
                GL.Translate(x, y, 0);
                moonCube.DrawCube();
                GL.PopMatrix();
